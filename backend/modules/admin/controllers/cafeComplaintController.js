import CafeComplaint from '../models/CafeComplaint.js';
import { successResponse, errorResponse } from '../../../shared/utils/response.js';
import { asyncHandler } from '../../../shared/middleware/asyncHandler.js';

/**
 * Get all cafe complaints
 * GET /api/admin/cafe-complaints
 */
 ...
 * GET /api/admin/cafe-complaints/:id
 */
export const getComplaintDetails = asyncHandler(async (req, res) => {
  try {
    ...
    const complaint = await CafeComplaint.findById(id)
      .populate('orderId')
      .populate('customerId', 'name phone email')
      .populate('cafeId', 'name cafeId profileImage')
      .populate('resolvedBy', 'name email')
      .lean();
 ...
 * PUT /api/admin/cafe-complaints/:id/status
 */
...
/**
 * Add internal notes
 * PUT /api/admin/cafe-complaints/:id/notes
 */
