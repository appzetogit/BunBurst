...
export const addStaff = asyncHandler(async (req, res) => {
  try {
    ...
    // Check if user already exists for this cafe
    ...
    if (req.file) {
      try {
        const uploadResult = await uploadToCloudinary(req.file.buffer, {
          folder: `appzeto/cafe/staff/${cafeId}`,
          resource_type: 'image',
          transformation: [
...
/**
 * Get all staff/manager for a cafe
 * GET /api/cafe/staff
 */
