...
export default function Cart() {
  ...
  useEffect(() => {
    ...
    // Use cartKey (stable fingerprint) + restaurantId so we only refetch when
    // cart contents or the restaurant actually change — not on every re-render.
  }, [cartKey, restaurantId])
  ...
  useEffect(() => {
    ...
    // Skip if restaurant hasn't loaded yet — the effect will re-run when it does
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [cartKey, addressKey, appliedCoupon?.code, couponCode, restaurantId, isPlacingOrder])
