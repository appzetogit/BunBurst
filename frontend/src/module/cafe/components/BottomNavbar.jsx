      ...
      <div className="flex items-center justify-around py-2 px-4">
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/cafe") ? "text-[#ff8100]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/cafe/orders") ? "text-[#ff8100]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 -mt-8 transition-colors ${
            isActive("/cafe/details") ? "text-[#ff8100]" : "text-gray-600"
          }`}
        >
          <div
            className={`rounded-full p-3 shadow-lg border-2 transition-colors ${
              isActive("/cafe/details")
          ...
          >
            <Store
              className={`w-6 h-6 ${
                isActive("/cafe/details") ? "text-white" : "text-gray-600"
              }`}
            />
          </div>
        </button>
        <button
          onClick={() => navigate("/cafe/wallet")}
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/cafe/wallet") ? "text-[#ff8100]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          onClick={(e) => {
            ...
            navigate("/cafe/food/all")
          }}
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/cafe/food/all") ? "text-[#ff8100]" : "text-gray-600"
          }`}
        >
