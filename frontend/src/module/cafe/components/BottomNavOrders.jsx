...
const ordersTabs = [
  { id: "orders", label: "Orders", icon: FileText, route: "/cafe" },
  { id: "inventory", label: "Inventory", icon: Package, route: "/cafe/inventory" },
  { id: "feedback", label: "Feedback", icon: MessageSquare, route: "/cafe/feedback" },
  { id: "explore", label: "Explore", icon: Compass, route: "/cafe/explore" },
]

const hubTabs = [
  { id: "hub", label: "  Hub  ", icon: Building2, route: "/cafe/to-hub" },
  { id: "growth", label: "Growth", icon: TrendingUp, route: "/cafe/hub-growth" },
  { id: "menu", label: "Menu", icon: Utensils, route: "/cafe/hub-menu" },
  { id: "finance", label: "Finance", icon: Wallet, route: "/cafe/hub-finance" },
]
...
export default function BottomNavOrders() {
  ...
  const isHubMode = useMemo(() => {
    return pathname.startsWith("/cafe/hub") || pathname.startsWith("/cafe/to-hub")
  }, [pathname])
  ...
  const handleToggleMode = () => {
    ...
    requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        setTimeout(() => {
          navigate(isHubMode ? "/cafe" : "/cafe/to-hub")
