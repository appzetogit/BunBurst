...
export default function PhoneNumbersPage() {
  ...
  const [editingNumber, setEditingNumber] = useState(null) // { type: 'orderReminder1' | 'orderReminder2' | 'cafePage' }
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        ...
        <div className="bg-white rounded-lg p-4 mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex-1">
              <h2 className="text-base font-bold text-gray-900">Cafe page number</h2>
              <p className="text-xs text-gray-600 mt-1">
                Number for Zomato customers to call your cafe.
              </p>
            </div>
          </div>
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between py-2">
              <div className="flex-1">
                <p className="text-base font-semibold text-gray-900">{getDisplayNumber("cafePage")}</p>
              </div>
              <button
                onClick={() => handleEditClick("cafePage")}
                className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
              >
                <Edit className="w-4 h-4 text-blue-600" />
              </button>
