...
export default function FinanceDetailsPage() {
  ...
  const settlementData = {
    ...
    netOrderValue: financeData?.netOrderValue || {
      ...
      cafeDiscountPromos: 500.00,
      cafeDiscountOthers: 300.00,
      total: 18500.00
    },
                          ...
                          >
                            <div className="px-4 pb-3 space-y-2 border-t border-dashed border-gray-200">
                              ...
                              <div className="flex items-center justify-between py-2 border-t border-dashed border-gray-200">
                                ...
                                <span className="text-sm font-medium text-gray-900">
                                  ₹{settlementData.netOrderValue.cafeDiscountPromos.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                </span>
                              </div>
                              <div className="flex items-center justify-between py-2 border-t border-dashed border-gray-200">
                                <div className="flex items-center gap-1.5">
                                ...
                                <span className="text-sm font-medium text-gray-900">
                                  ₹{(settlementData.netOrderValue?.cafeDiscountOthers || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                </span>
                              </div>
                            </div>
                          </motion.div>
