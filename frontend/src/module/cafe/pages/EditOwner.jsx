...
const STORAGE_KEY = "cafe_owner_contact"
...
export default function EditOwner() {
  ...
  // Fetch cafe data from backend on mount
  useEffect(() => {
  ...
  const handleSave = async () => {
    try {
      ...
      if (profileImageFile) {
        try {
          const imageResponse = await cafeAPI.uploadProfileImage(profileImageFile)
      ...
      const response = await cafeAPI.updateProfile(updatePayload)
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      // Clear all cafe-related localStorage data
      ...
      localStorage.removeItem("cafe_invited_users")
