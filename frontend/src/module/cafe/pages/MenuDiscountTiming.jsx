...
export default function MenuDiscountTiming() {
  ...
  const getBackPath = () => {
    if (discountType === "percentage-menu") return "/cafe/hub-growth/create-offers/delight-customers/percentage"
    if (discountType === "flat-price-menu") return "/cafe/hub-growth/create-offers/delight-customers/flat-price"
    if (discountType === "bogo-menu") return "/cafe/hub-growth/create-offers/delight-customers/bogo"
    return "/cafe/hub-growth/create-offers/delight-customers"
  }
