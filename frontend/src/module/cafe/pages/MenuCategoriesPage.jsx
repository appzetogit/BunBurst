...
export default function MenuCategoriesPage() {
  ...
  const fetchCategories = async () => {
    try {
      setLoading(true)
      const response = await cafeAPI.getAllCategories()
  ...
  const handleSaveCategory = async () => {
    ...
    try {
      ...
      if (editingCategory) {
        ...
        await cafeAPI.updateCategory(editingCategory._id || editingCategory.id, categoryData)
        toast.success('Category updated successfully')
      } else {
        // Create new category
        await cafeAPI.createCategory(categoryData)
  ...
  const handleDeleteCategory = async (category) => {
    ...
    try {
      await cafeAPI.deleteCategory(category._id || category.id)
  ...
  const handleToggleActive = async (category) => {
    try {
      await cafeAPI.updateCategory(category._id || category.id, {
