  ...
  return (
    <div className="min-h-screen bg-[#f6e9dc] overflow-x-hidden pb-20 md:pb-6">
          ...
          {filteredAds.map((ad, index) => (
            ...
            >
              <Card className="bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow cursor-pointer"
                onClick={() => navigate(`/cafe/advertisements/${ad.id}`)}
              >
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0 relative">
                      ...
                      <AnimatePresence>
                        {openMenuId === ad.id && (
                          ...
                          >
                            {[
                              { icon: Eye, label: "View Ads", action: () => navigate(`/cafe/advertisements/${ad.id}`) },
                              { icon: Edit, label: "Edit Ads", action: () => navigate(`/cafe/advertisements/${ad.id}/edit`) },
                      ...
                      <motion.button 
                        ...
                        whileTap={{ scale: 0.9 }}
                        onClick={() => {
                          navigate(`/cafe/advertisements/${ad.id}`)
                        }}
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        onClick={() => {
          navigate("/cafe/advertisements/new")
        }}
