    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="sticky top-0 z-40 bg-white border-b border-gray-200 px-4 py-3">
        <div className="flex items-center gap-3">
          <button
            onClick={() => navigate("/cafe/hub-growth/create-offers")}
          ...
          {menuDiscountTypes.map((type, index) => (
            <motion.div
              ...
              onClick={() => {
                ...
                if (type.id === "freebies") {
                  navigate("/cafe/hub-growth/create-offers/delight-customers/freebies")
                } else if (type.id === "percentage") {
                  navigate("/cafe/hub-growth/create-offers/delight-customers/percentage")
                } else if (type.id === "flat-price") {
                  navigate("/cafe/hub-growth/create-offers/delight-customers/flat-price")
                } else if (type.id === "bogo") {
                  navigate("/cafe/hub-growth/create-offers/delight-customers/bogo")
                } else {
                  navigate(`/cafe/hub-growth/create-offers/delight-customers/${type.id}`)
                }
              }}
