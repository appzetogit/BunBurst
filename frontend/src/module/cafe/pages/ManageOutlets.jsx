  ...
  const handleOptionClick = (option) => {
    ...
    switch (option) {
      case "Timings":
        ...
        break
      case "Contacts":
        navigate("/cafe/contact-details")
        break
      case "FSSAI Food License":
        navigate("/cafe/fssai")
        break
      case "Bank account details":
        navigate("/cafe/update-bank-details")
        break
      case "Profile picture":
        navigate("/cafe/outlet-info")
        break
      case "Name, address, location":
        navigate("/cafe/outlet-info")
        break
      case "Ratings, reviews":
        navigate("/cafe/ratings-reviews")
        break
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="px-4 pt-4 pb-3 flex items-center gap-3 border-b border-gray-200">
        ...
        <h1 className="text-lg font-bold text-gray-900">Cafe</h1>
      </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 space-y-2">
                  <p className="text-sm font-semibold text-gray-900">
                    You can not modify the delivery areas of your cafe
                  </p>
