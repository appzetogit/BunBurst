...
import { authAPI, cafeAPI } from "@/lib/api"
  ...
  const settingsSections = [
    {
      ...
      items: [
        ...
        { id: "privacy", label: "Privacy & Security", icon: Shield, route: "/cafe/privacy" },
      ]
    },
    {
      id: "preferences",
      title: "Preferences",
      items: [
        { id: "language", label: "Language", icon: Globe, route: "/cafe/language", value: "English" },
    ...
    },
    {
      ...
      items: [
        { id: "conversation", label: "Conversation", icon: MessageSquare, route: "/cafe/conversation" },
        { id: "terms", label: "Terms & Conditions", icon: FileText, route: "/cafe/terms" },
        { id: "privacy-policy", label: "Privacy Policy", icon: Shield, route: "/cafe/privacy" },
        { id: "about", label: "About", icon: Info, route: "/cafe/about" },
      ]
    },
    {
      id: "actions",
      ...
      items: [
        {
          id: "logout", label: "Logout", icon: LogOut, isDestructive: true, action: async () => {
            ...
            try {
              ...
              navigate("/cafe/auth/sign-in", { replace: true })
            } catch (err) {
