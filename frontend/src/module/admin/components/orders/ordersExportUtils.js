...
export const exportToExcel = (orders, filename = "orders") => {
  ...
  if (isSubscription) {
    ...
    headers = ["SI", "Order ID", "Order Date", "Order Time", "Customer Name", "Customer Phone", "Cafe Name", "Delivery Boy Name", "Delivery Boy Phone", "Status", "Total Amount", "Payment Status"]
    rows = orders.map((order, index) => {
