...
export default function CafeComplaints() {
  ...
  const fetchComplaints = async () => {
    try {
      ...
      const response = await adminAPI.getCafeComplaints(params)
  ...
  const handleStatusUpdate = async (complaintId, nextStatus) => {
    try {
      ...
      const response = await adminAPI.updateCafeComplaintStatus(complaintId, nextStatus)
              ...
              <div key={complaint._id} className="p-4 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-600">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{complaint.cafeName}</p>
                      </div>
                      <div>
                ...
                {complaint.cafeResponse && (
                  <div className="bg-blue-50 rounded p-3 mb-3">
                    ...
                    <p className="text-sm text-blue-800">{complaint.cafeResponse}</p>
                  </div>
                )}
