    ...
    try {
      ...
      if (settings) {
        setFormData({
          ...
          enableDelivery: settings.orderingOptions?.enableDelivery !== false,
          enablePickup: settings.orderingOptions?.enablePickup !== false,
        });
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="md:col-span-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <label className="flex items-center justify-between gap-3 border border-slate-200 rounded-lg px-3 py-2 bg-slate-50/60">
                    <span className="text-xs text-slate-700 font-medium">Enable Delivery</span>
                    <input
                      type="checkbox"
                  ...
                  <label className="flex items-center justify-between gap-3 border border-slate-200 rounded-lg px-3 py-2 bg-slate-50/60">
                    <span className="text-xs text-slate-700 font-medium">Enable Pickup</span>
                    <input
                      type="checkbox"
                ...
                {!formData.enableDelivery && !formData.enablePickup && (
                  <p className="mt-2 text-xs text-rose-600">
                    If both options are disabled, customers cannot place orders.
                  </p>
                )}
              </div>
            </div>
