...
const databaseTables = [
  ...
  { name: "Cafe_configs", count: 9 },
  { name: "Cafe_tag", count: 0 },
  ...
  { name: "Cafe_schedule", count: 105 },
  { name: "Cafe_wallets", count: 15 },
  { name: "Shifts", count: 3 },
